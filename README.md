...
For the **official plugins** that live within the OpenSearch organization (i.e. they are included
...
3) Change all these path occurrences to match your chosen path and naming by
